...
module.exports = {
  ...
  NODE_AMOUNT: { tree: 30, stone: 20, iron: 12, sand: 25, silver: 10 }, // ресурса за ноду (запас)
  ...
  TILES: {
    ...
    ADMIN_CHEST: 34, // тест: сундук, из которого можно взять любой предмет
    SILVER_ORE: 35,  // жила серебряной руды (добывается киркой)
  },
  // Порталы (13,14,16,17,18), пещерный пол 15, точка спавна 19, полы 20-23/31 и мост 29 — проходимы.
  BLOCKED: [1, 2, 3, 5, 6, 7, 8, 9, 10, 11, 12, 24, 25, 26, 27, 28, 30, 32, 33, 34, 35],
