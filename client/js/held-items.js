...
// size — ширина инструмента в координатах тела (увеличены ×1.3 — крупнее на персонаже). Оверлей не обрезается.
export const HELD_ITEMS = {
  pickaxe: { src: ITEM_TEX.pickaxe, hand: 'right', size: 390, grip: { x: 0.18, y: 0.82 }, rot: 0 },
  axe:     { src: ITEM_TEX.axe,     hand: 'right', size: 390, grip: { x: 0.18, y: 0.82 }, rot: 0 },
  shovel:  { src: ITEM_TEX.shovel,  hand: 'right', size: 520, grip: { x: 0.46, y: 0.82 }, rot: 0 },
  fishingRod: { src: ITEM_TEX.fishingRod, hand: 'right', size: 361, grip: { x: 0.147, y: 0.867 }, rot: 0 },
};
