...
export const ITEMS = {
  ...
  wood:    { name: 'Древесина', type: 'resource', cat: 'material', price: 1, tags: ['материал','крафт','дерево'], desc: 'Базовый материал. Добывается топором из деревьев.' },
  stone:   { name: 'Камень',    type: 'resource', cat: 'material', price: 2, tags: ['материал','крафт','строительство'], desc: 'Добывается киркой из каменных глыб.' },
  ore:     { name: 'Железная руда',   type: 'resource', cat: 'material', price: 6, tags: ['материал','металл','плавка'], desc: 'Добывается киркой из жил руды. Плавится в слитки на плавильне.' },
  ingot:   { name: 'Железный слиток',  type: 'resource', cat: 'material', price: 14, tags: ['материал','металл','крафт','кузнечное дело'], desc: 'Выплавляется из руды на плавильне. Основной материал для брони и инструментов.' },
  rawChicken:    { name: 'Сырая курица',   type: 'ingredient', cat: 'ingredient', price: 3, tags: ['ингредиент','мясо','готовка'], desc: 'Выпадает с курицы. Сырое мясо не лечит — приготовь его на костре.' },
  cookedChicken: { name: 'Жареная курица', type: 'food',       cat: 'food', heal: 10, price: 6, tags: ['еда','лечение','готовка'], desc: 'Готовится на костре из сырой курицы. Съешь, чтобы восстановить здоровье.' },
